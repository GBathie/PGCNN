...
parser.add_argument(
    "--split", type=int, default=1, help="CV split that is used for validation (default: 0)"
)
parser.add_argument(
    "--total-split", type=int, default=10, help="Total number of CV splits (default: 10)"
)
parser.add_argument("--pred-path", default=None, help="path to prediction csv")
parser.add_argument(
    "--fea-len", type=int, default=16, help="feature length for the network (default: 16)"
)
parser.add_argument(
    "--lr",
    type=float,
...
parser.add_argument(
    "--n-layers", type=int, default=4, help="number of graph convolution layers (default: 4)"
)
parser.add_argument(
    "--n-h", type=int, default=2, help="number of hidden layers after pool (default: 2)"
)
parser.add_argument("--epochs", type=int, default=20, help="number of epochs (default: 200)")
parser.add_argument("--batch-size", type=int, default=16, help="batch size (default: 16)")
parser.add_argument("--has-h", type=int, default=0, help="whether to have explicit H (default: 0)")
parser.add_argument(
    "--form-ring", type=int, default=1, help="whether to form ring for molecules (default: 1)"
)
parser.add_argument("--log10", type=int, default=1, help="whether to use the log10 of the property")
parser.add_argument(
    "--size-limit", type=int, default=None, help="limit the size of training data (default: None)"
)
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        print(
            "Epoch: {:03d}, LR: {:8f}, Loss: {:.7f}, Validation MAE: {:.10f}, "
